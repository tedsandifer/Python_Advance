...
def create_camera(cam_name):
   ...
   cmds.rename(new_cam_trans, cam_name + "_Cam")

# Create Focus Group --------------------------------------------------
def create_focus_grp(cam_name):
   ...
   focus_lock_list = ['.tx', '.ty', '.tz', '.rx', '.ry', '.rz', '.sx', '.sy', '.sz']
   ...
   cmds.setAttr(cam_name + '_focusGrp.v', 0, keyable=False, channelBox=False)



# Create Cam Rig Base -----------------------------------------------------------------
def create_cam_rig_base(cam_name):
...
# Offset -------------------------------------------------------------------
def create_cam_rig_offset(cam_name):
...
# Trans -------------------------------------------------------------------
def create_cam_rig_trans(cam_name):
...
# Tilt -------------------------------------------------------------------
def create_cam_rig_tilt(cam_name):
...
# Pan -------------------------------------------------------------------
def create_cam_rig_pan(cam_name):
...
# Roll -------------------------------------------------------------------
def create_cam_rig_roll(cam_name):
...
# Shake -----------------------------------------------------------------
def create_cam_rig_shake(cam_name):
...
def build_cam_rig(cam_name):
   ...
   if cam_name == '':
      ...
      create_camera(cam_name)
      create_focus_grp(cam_name)
      create_cam_rig_base(cam_name)
      create_cam_rig_offset(cam_name)
      create_cam_rig_trans(cam_name)
      create_cam_rig_pan(cam_name)
      create_cam_rig_tilt(cam_name)
      create_cam_rig_roll(cam_name)
      create_cam_rig_shake(cam_name)
      create_cam_all(cam_name)

      cmds.parent(cam_name + '_focusGrp', cam_name + "_Cam")
      cmds.group(name = cam_name + '_connect', empty=True)
      cmds.parent(cam_name + "_Cam", cam_name + '_connect')
